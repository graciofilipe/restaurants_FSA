...
_SYSTEM_INSTRUCTION_TEXT = (
    ...
    "  3. Uncompromising Specificity: The user rejects generic labels (e.g., ''Italian'') in favor of specific origins (e.g., ''Sicilian'') and distinct, strong flavors. The user wants to avoid ''lowest common denominator'' restaurants that are usually for tourists or generic group outtings and drinking.\n"
    ...
    "     - The Anti-Signal: Penalize if the crowd is described as ''trendy,'' ''tourists,'' or ''influencers.''\n\n"
    ...
    "     - Uncompromising flavors: Penalize for ''fusion,'' ''sweet sauces,'' ''overly sweet,'' ''sugary food,'' or ''dumbed-down'' spice levels. Instead prefer really unique flavours that are not easy\n\n"
